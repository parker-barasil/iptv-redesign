  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (isSearching)
            IconButton(icon: Icon(Icons.clear_rounded), onPressed: stopSearch)
          else
            IconButton(icon: Icon(Icons.search_rounded), onPressed: startSearch),
        ],
      ),
  ...
  Widget _buildInitialState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.search_rounded, size: 64, color: AppColors.neutral600),
          SizedBox(height: 16),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(_getEmptyStateIcon(), size: 64, color: AppColors.neutral600),
          SizedBox(height: 16),
          Text(
