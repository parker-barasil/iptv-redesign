    ...
    if (hasError) {
      return Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.error_outline_rounded, color: AppColors.errorPink, size: 32),
        ...
        if (widget.onFullscreen != null)
          Positioned(
            ...
            child: IconButton(
              ...
              icon: const Icon(Icons.fullscreen_rounded, color: AppColors.white, size: 24),
              style: IconButton.styleFrom(backgroundColor: AppColors.neutralDark900),
            ),
          ),
      ],
    );
